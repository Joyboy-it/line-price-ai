...
import { Megaphone, Tag, Clock, ChevronRight, CheckCircle, Building2 } from 'lucide-react';
        ...
        <section className="bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl shadow-sm p-6 border border-purple-100 mb-8" style={{ minHeight: '140px' }}>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-gray-900">แผนกที่ร้าน</p>
                <p className="text-sm text-gray-500">ข้อมูลแผนกและหน่วยงาน</p>
              </div>
            </div>
